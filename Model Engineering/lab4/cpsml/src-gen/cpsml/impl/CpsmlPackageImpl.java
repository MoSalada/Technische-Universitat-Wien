...
public class CpsmlPackageImpl extends EPackageImpl implements CpsmlPackage {
	 ...
	 * @generated
	 */
	public EOperation getNode__StatusBasedOnComponents_c1__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getFunction__ReturnAndNotNull_c3__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getFunction__SensorRequiresReturn_c3__DiagnosticChain_Map() {
	 ...
	 * @generated
	 */
	public EOperation getConnectionModule__NamingConvention_cS2__DiagnosticChain_Map() {
		return connectionModuleEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getWirelessModule__NoConnectionToSelf_cS3a__DiagnosticChain_Map() {
		return wirelessModuleEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getWirelessModule__RangePositive_cS4__DiagnosticChain_Map() {
		return wirelessModuleEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getWirelessModule__DistancesWihtinRange_c4__DiagnosticChain_Map() {
		return wirelessModuleEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getWiredModule__NoConnectionToSelf_cS3b__DiagnosticChain_Map() {
		return wiredModuleEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getMessagingLink__MessagingElementConnectedToMB_c2__DiagnosticChain_Map() {
		return messagingLinkEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getMessagingLink__CommonTopicsWithMB_cS1b__DiagnosticChain_Map() {
		return messagingLinkEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getMessagingLink__CommonTopicsWithNode_cS1a__DiagnosticChain_Map() {
		return messagingLinkEClass.getEOperations().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(nodeEClass, NODE___STATUS_BASED_ON_COMPONENTS_C1__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(functionEClass, FUNCTION___RETURN_AND_NOT_NULL_C3__DIAGNOSTICCHAIN_MAP);
		createEOperation(functionEClass, FUNCTION___SENSOR_REQUIRES_RETURN_C3__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(connectionModuleEClass, CONNECTION_MODULE___NAMING_CONVENTION_CS2__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(wirelessModuleEClass, WIRELESS_MODULE___NO_CONNECTION_TO_SELF_CS_3A__DIAGNOSTICCHAIN_MAP);
		createEOperation(wirelessModuleEClass, WIRELESS_MODULE___RANGE_POSITIVE_CS4__DIAGNOSTICCHAIN_MAP);
		createEOperation(wirelessModuleEClass, WIRELESS_MODULE___DISTANCES_WIHTIN_RANGE_C4__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(wiredModuleEClass, WIRED_MODULE___NO_CONNECTION_TO_SELF_CS_3B__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(messagingLinkEClass,
				MESSAGING_LINK___MESSAGING_ELEMENT_CONNECTED_TO_MB_C2__DIAGNOSTICCHAIN_MAP);
		createEOperation(messagingLinkEClass, MESSAGING_LINK___COMMON_TOPICS_WITH_MB_CS_1B__DIAGNOSTICCHAIN_MAP);
		createEOperation(messagingLinkEClass, MESSAGING_LINK___COMMON_TOPICS_WITH_NODE_CS_1A__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getNode__StatusBasedOnComponents_c1__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "statusBasedOnComponents_c1", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getFunction__ReturnAndNotNull_c3__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"returnAndNotNull_c3", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getFunction__SensorRequiresReturn_c3__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"sensorRequiresReturn_c3", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getConnectionModule__NamingConvention_cS2__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "namingConvention_cS2", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getWirelessModule__NoConnectionToSelf_cS3a__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "noConnectionToSelf_cS3a", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getWirelessModule__RangePositive_cS4__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"rangePositive_cS4", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getWirelessModule__DistancesWihtinRange_c4__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "distancesWihtinRange_c4", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getWiredModule__NoConnectionToSelf_cS3b__DiagnosticChain_Map(), ecorePackage.getEBoolean(),
				"noConnectionToSelf_cS3b", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getMessagingLink__MessagingElementConnectedToMB_c2__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "messagingElementConnectedToMB_c2", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getMessagingLink__CommonTopicsWithMB_cS1b__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "commonTopicsWithMB_cS1b", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getMessagingLink__CommonTopicsWithNode_cS1a__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "commonTopicsWithNode_cS1a", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(functionEClass, source, new String[] { "constraints", "sensorRequiresReturn_c3" });
		addAnnotation(connectionModuleEClass, source, new String[] { "constraints", "namingConvention_cS2" });
		addAnnotation(wirelessModuleEClass, source, new String[] { "constraints", "distancesWihtinRange_c4" });
		addAnnotation(wiredModuleEClass, source, new String[] { "constraints", "noConnectionToSelf_cS3b" });
		addAnnotation(messagingLinkEClass, source, new String[] { "constraints", "commonTopicsWithNode_cS1a" });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(getNode__StatusBasedOnComponents_c1__DiagnosticChain_Map(), source, new String[] { "body",
				"\n\t\t\tself.status = Status::GOOD implies self.component->forAll(c| c.status = Status::GOOD)" });
		addAnnotation(getFunction__ReturnAndNotNull_c3__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tself.hasReturn implies returnDataType <> DataType::NULL" });
		addAnnotation(getFunction__SensorRequiresReturn_c3__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tself.oclContainer.oclIsTypeOf(Sensor) implies hasReturn\n\t\t\t" });
		addAnnotation(getConnectionModule__NamingConvention_cS2__DiagnosticChain_Map(), source, new String[] { "body",
		...
		addAnnotation(getWirelessModule__NoConnectionToSelf_cS3a__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tself.connect->excludes(self)\n\t\t" });
		addAnnotation(getWirelessModule__RangePositive_cS4__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tself.range >= 0" });
		addAnnotation(getWirelessModule__DistancesWihtinRange_c4__DiagnosticChain_Map(), source, new String[] { "body",
		...
		addAnnotation(getWiredModule__NoConnectionToSelf_cS3b__DiagnosticChain_Map(), source,
				new String[] { "body", "\n\t\t\tself.connect->excludes(self)\n\t\t" });
		addAnnotation(getMessagingLink__MessagingElementConnectedToMB_c2__DiagnosticChain_Map(), source, new String[] {
				"body",
		...
		addAnnotation(getMessagingLink__CommonTopicsWithMB_cS1b__DiagnosticChain_Map(), source, new String[] { "body",
		...
		addAnnotation(getMessagingLink__CommonTopicsWithNode_cS1a__DiagnosticChain_Map(), source, new String[] { "body",
