 ...
 * </p>
 * <ul>
 *   <li>{@link cpsml.impl.ComponentImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link cpsml.impl.ComponentImpl#getFunction <em>Function</em>}</li>
 *   <li>{@link cpsml.impl.ComponentImpl#getTopic <em>Topic</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ComponentImpl extends NamedElementImpl implements Component {
	...
	protected EClass eStaticClass() {
		return CpsmlPackage.Literals.COMPONENT;
	}
	...
	public void setStatus(Status newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpsmlPackage.COMPONENT__STATUS, oldStatus, status));
	}
	...
	public EList<Function> getFunction() {
		if (function == null) {
			function = new EObjectContainmentEList<Function>(Function.class, this, CpsmlPackage.COMPONENT__FUNCTION);
		}
		return function;
	}
	...
	public void setTopic(String newTopic) {
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpsmlPackage.COMPONENT__TOPIC, oldTopic, topic));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CpsmlPackage.COMPONENT__FUNCTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpsmlPackage.COMPONENT__STATUS:
			return getStatus();
		case CpsmlPackage.COMPONENT__FUNCTION:
			return getFunction();
		case CpsmlPackage.COMPONENT__TOPIC:
			return getTopic();
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == StatefulElement.class) {
			...
			case CpsmlPackage.STATEFUL_ELEMENT__STATUS:
				return CpsmlPackage.COMPONENT__STATUS;
			default:
				return -1;
			}
		}
