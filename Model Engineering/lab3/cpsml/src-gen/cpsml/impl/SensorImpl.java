 ...
 * </p>
 * <ul>
 *   <li>{@link cpsml.impl.SensorImpl#getFrequency <em>Frequency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SensorImpl extends ComponentImpl implements Sensor {
	...
	protected EClass eStaticClass() {
		return CpsmlPackage.Literals.SENSOR;
	}
	...
	public void setFrequency(float newFrequency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpsmlPackage.SENSOR__FREQUENCY, oldFrequency,
					frequency));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CpsmlPackage.SENSOR__FREQUENCY:
			return getFrequency();
		}
